                    ...
                    <form id="form-transaksi" method="POST" action="{{ route('transaksis.store') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select id="barang_id" class="form-control">
                                    ...
                                    <option value="{{ $barang->id }}" data-harga="{{ $barang->harga_jual }}" data-nama="{{ $barang->nama }}">
                                        {{ $barang->nama }} (Stok: {{ $barang->stok }}) - Rp {{ number_format($barang->harga_jual,0,',','.') }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="number" id="bayar" name="bayar" class="form-control" min="0" value="0">
                            </div>
                            <div class="col-md-4">
