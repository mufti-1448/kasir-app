                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_pembeli" id="nama_pembeli" class="form-control"
                                               placeholder="Masukkan nama pembeli (opsional)" value="{{ old('nama_pembeli') }}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <table class="table table-bordered table-hover" id="tabel-transaksi">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <input type="number" name="bayar" id="bayar" class="form-control"min="0" required value="{{ old('bayar', 0) }}">
                                            </th>
                                            <th></th>
                                        </tr>
                                        <tr class="table-info">
