...
document.addEventListener('DOMContentLoaded', function() {
    ...
    btnTambah.addEventListener('click', function() {
        ...
        if (existingItem) {
            ...
            const newItem = { barangId, kode, nama, harga, jumlah };
            items.push(newItem);
            ...
            newRow.querySelector('.btn-hapus').addEventListener('click', function() {
                // Kembalikan stok
                const selectedOption = barangSelect.querySelector(`option[value="${barangId}"]`);
    ...
    items.forEach((item, index) => {
        ...
        inputBarang.name = `items[${index}][barang_id]`;
...
<style>
    ...
    #stok-info { display: block; margin-top: 5px; font-weight: 500; }
    .is-invalid { border-color: #dc3545; }
    #tabel-transaksi td, #tabel-transaksi th { vertical-align: middle; }
    .btn-hapus { min-width: 40px; }
</style>
@endsection
