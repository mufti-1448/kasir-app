...
@section('scripts')
    ...
    inputBarang.name = `barang_id[${index}]`; // <--- harus sesuai 'barang_id.*'
    inputBarang.value = item.barangId;
    form.appendChild(inputBarang);

    const inputJumlah = document.createElement('input');
    inputJumlah.type = 'hidden';
    inputJumlah.name = `jumlah[${index}]`; // <--- harus sesuai 'jumlah.*'
    ...
    inputHarga.name = `harga_satuan[${index}]`; // <--- harus sesuai 'harga_satuan.*'
